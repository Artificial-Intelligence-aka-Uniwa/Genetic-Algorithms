...
#define NPOINTS		25//12 //25					/* The number of points (villages/cities) */
#define CITIES_FILE	"Halkidiki_25.txt"	 // "Halkidiki_12.txt"
#define RESULTS_FILE "results_25.txt"	// "results_12.txt"
#define POPSIZE		1000//1000				/* Population size */
#define PXOVER		0.7//0.7					/* Probability of crossover */
#define PMUTATION	0.1//0.05				/* Probability of mutation */
#define MAXGENS		100//100					/* Maximum number of generations */
